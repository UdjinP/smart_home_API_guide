...
|----------|----------|-------------|-----------------------------------------|
| -        | есть     | -           | уст. сост. ноды                         |
| -        | есть     | есть        | уст. сост. ноды (для сценария)          |
| есть     | -        | есть        | уст. сост. группы нодов (для сценария)  |
| есть     | есть     | -           | уст. сост. группы нодов (для ноды)      |
...
- id_node (привязка ноды к группе)
- name
