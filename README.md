...
### Таблицы
Описание таблиц
#### Access - Активность пользователя в сети net с указанием прав
...
#### Icons
Цвета иконок. Id_icon является именем файла иконки, лежащей на сервере в каталоге /icons,
...
#### Icon_colors
Таблица переназначения цветов иконок для пользователя.
