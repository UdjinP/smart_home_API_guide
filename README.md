...
|----------|----------|-------------|-----------------------------------------|
| -        | есть     | -           | уст. сост. ноды                         |
| -        | есть     | есть        | уст. сост. ноды (сценарий)              |
| есть     | -        | -           | уст. сост. группы нодов                 |
| есть     | -        | есть        | уст. сост. группы нодов (сценарий)      |
| есть     | есть     | -           | привязка ноды к группе нодов            |
| есть     | есть     | есть        | привязка ноды к группе нодов (сценарий) |
...
- id_node (код ноды, которой принадлежит группа)
- name
